...
class SnakeGame:
    ...
    def voting_system(self):
        while self.running:
            time.sleep(10)  # Esperar 10 segundos para recoger votos
...
class VotingWindow:
    def __init__(self):
        ...
        self.btn_up = tk.Button(self.root, text="Arriba", command=lambda: insertar_voto("UP"))
        self.btn_up.pack()
        
        self.btn_down = tk.Button(self.root, text="Abajo", command=lambda: insertar_voto("DOWN"))
        self.btn_down.pack()
        
        self.btn_left = tk.Button(self.root, text="Izquierda", command=lambda: insertar_voto("LEFT"))
        self.btn_left.pack()
        
        self.btn_right = tk.Button(self.root, text="Derecha", command=lambda: insertar_voto("RIGHT"))
        self.btn_right.pack()
